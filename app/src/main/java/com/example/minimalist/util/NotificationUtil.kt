...
import com.example.minimalist.AppConstants
import com.example.minimalist.MainActivity
import com.example.minimalist.R
import com.example.minimalist.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object {
        ...
        private const val CHANNEL_NAME_TIMER = "Minimalist Timer"
        ...
        fun showTimerExpired(context: Context){
            ...
            nBuilder.setContentTitle("Pomodoro Expired!")
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long){
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            nBuilder.setContentTitle("Pomodoro is Running.")
        ...
        fun showTimerPaused(context: Context){
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            nBuilder.setContentTitle("Pomodoro is paused.")
